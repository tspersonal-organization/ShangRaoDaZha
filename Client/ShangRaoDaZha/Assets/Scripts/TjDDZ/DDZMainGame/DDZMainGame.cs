...
public class DDZMainGame : UIBase<DDZMainGame>
{
    ...
    public void OnShowFriendCard(int pos, uint CardValue)
    {
        if (pos != 0)
        {
            ...
            {
                IdAndPlayerDic[GameData.m_TableInfo.ZhuangPos].transform.Find("OtherPanel").Find("HelperSprite").gameObject.SetActive(true);
    ...
    public void OnShowBaoPaiInfo(int pos)
    {
        ...
        if (pos != 0)
        {
            ...
            else//别人包牌
            {
                ...
                {
                    if ((i + 1) == pos) continue;
                    IdAndPlayerDic[i + 1].transform.Find("OtherPanel").Find("HelperSprite").gameObject.SetActive(true);
                }
      ...
      //  ResetPlayerAI();//重置托管
        ...
        else if (GameData.m_TableInfo.roomState == RoomStatusType.Play)
        {
            ...
            if (GameData.sendroominfo.PlayStatusInfo.BaoPaiPosition == (uint)PositionType.None)//没有包牌
            {
                ...
                {
                    IdAndPlayerDic[GameData.m_TableInfo.ZhuangPos].transform.Find("OtherPanel").Find("HelperSprite").gameObject.SetActive(true);
                    IdAndPlayerDic[GameData.m_TableInfo.FriendPos].transform.Find("OtherPanel").Find("HelperSprite").gameObject.SetActive(true);
                }
                else
                {
                    for (int i = 1; i < IdAndPlayerDic.Count+1; i++)
