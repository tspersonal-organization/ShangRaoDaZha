...
public class ZaiBaiGame : UIBase<ZaiBaiGame>
{
    ...
    void OnClickBtn(GameObject go)
    {
        ...
        switch (go.name)
        {
            case "btnInvite":
                ...
                //  AuthorizeOrShare.Instance.ShareRoomID(GameData.m_TableInfo.id, shareStr, "【闲娱狗载宝】");

                switch ((int)GameData.m_TableInfo.configPayIndex)
                {
                    case 0:
                        AuthorizeOrShare.Instance.ShareRoomID(GameData.m_TableInfo.id, "一起来玩闲娱狗吧！" + ((int)GameData.m_TableInfo.configRoundIndex).ToString() + "局!" + (GameData.m_PlayerInfoList.Count).ToString()+ "缺" + (4 - GameData.m_PlayerInfoList.Count).ToString() + "!" + "  房主支付!", "闲娱狗栽宝");
                        break;
                    case 1:
                        AuthorizeOrShare.Instance.ShareRoomID(GameData.m_TableInfo.id, "一起来玩闲娱狗吧！" + ((int)GameData.m_TableInfo.configRoundIndex).ToString() + "局!" + (GameData.m_PlayerInfoList.Count).ToString() + "缺"  + (4 - GameData.m_PlayerInfoList.Count).ToString() + "!" + "  平摊支付!", "闲娱狗栽宝");
                        break;
                }
                break;
            case "btnChat":
